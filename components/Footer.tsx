  ...
  export const Footer = () => {
    return (
      <footer className="bg-[#050B20] text-white py-16 md:px-6 lg:px-0 font-sans">
        <div className="container mx-auto px-4">
          {/* Newsletter Section */}
          <div className="flex flex-col md:flex-row justify-between items-center mb-16">
            <div>
              <h3 className=" text-sm lg:text-xl font-semibold mb-2">Sign up for news and resources</h3>
              <p className=" text-xs lg:text-xl text-gray-400">Unsubscribe at any time.</p>
            </div>
            <div className="flex text-sm lg:text-xl gap-4 mt-4 md:mt-0">
              <input
                type="email"
                placeholder="email@detail.co"
                className="bg-[rgba(206,201,211,0.15)] px-4 py-2 rounded-full w-64 focus:outline-none"
              />
              <button className="   text-sm lg:text-xl    bg-gradient-to-r from-[#9AE144] to-[#1F5B05] text-white px-5 py-1 rounded-full hover:opacity-90 transition-all">
                Sign Up
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-16">
            <div>
              <h4 className="font-semibold text-sm lg:text-xl mb-4">Detail</h4>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-sm lg:text-xl">Use Cases</h4>
              <ul className="space-y-2 text-sm lg:text-xl">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-sm lg:text-xl">Resources</h4>
              <ul className="space-y-2 text-sm lg:text-xl">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-sm lg:text-xl">Social</h4>
              <ul className="space-y-2 text-sm lg:text-xl">
            ...
            <div>
              <h4 className="font-semibold mb-4 text-sm lg:text-xl">Legal</h4>
              <ul className="space-y-2 text-sm lg:text-xl">
          ...
          {/* Footer Bottom */}
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 text-sm lg:text-xl border-t border-gray-800">
