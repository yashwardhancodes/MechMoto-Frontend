...
import { useCreateVendorMutation } from '@/lib/redux/api/vendorSlice';
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 text-[#9AE144] transition-transform duration-200 ${countryDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
                {countryDropdownOpen && (
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 text-[#9AE144] transition-transform duration-200 ${cityDropdownOpen ? 'rotate-180' : ''}`} />
                </button>
                {cityDropdownOpen && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#808080] rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
                    {cities.map((city) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className={`w-5 h-5 text-[#9AE144] transition-transform duration-200 ${stateDropdownOpen ? 'rotate-180' : ''}`} />
              </button>
              {stateDropdownOpen && (
                <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-[#808080] rounded-lg shadow-lg z-10 max-h-48 overflow-y-auto">
                  {states.map((state) => (
