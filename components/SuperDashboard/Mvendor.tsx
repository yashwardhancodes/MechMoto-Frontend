		...
		<div className="p-6 bg-white rounded shadow-sm">
			<div className="flex justify-between items-center mb-2">
				...
				<div className="flex gap-2">
					<button
						onClick={onAddVendor}
						className="flex items-center font-semibold text-black px-3 py-2 gap-2 rounded text-sm"
					>
			...
			<div className="flex justify-between items-center mt-4">
				...
				<div className="flex items-center gap-2">
					...
					<button className="w-6 h-6 rounded-full bg-[#9AE144] text-white text-sm">
						1
					</button>
					<button className="w-6 h-6 rounded-full text-sm text-[#9AE144] bg-gray-200">
						2
					</button>
