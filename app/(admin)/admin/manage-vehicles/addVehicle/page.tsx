        ...
        <div className="space-y-9">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              >
                <span className={formData.carMakeId && carMakes.length > 0 ? "text-gray-700" : "text-gray-400"}>
                  {carMakesLoading
                    ? "Loading..."
                    : carMakesError
                    ? "Error loading makes"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              >
                <span className={formData.engineTypeId && engineTypes.length > 0 ? "text-gray-700" : "text-gray-400"}>
                  {engineTypesLoading
                    ? "Loading..."
                    : engineTypesError
