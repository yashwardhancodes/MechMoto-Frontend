          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-col justify-center items-center">
              <div className="flex flex-col">
                <Image src={logo} alt="logo" className="size-12 md:size-16 lg:size-[88px]" />
              </div>
              <h1 className="font-sans font-semibold text-xl md:text-2xl lg:text-4xl">Welcome!</h1>
              <p className="text-xs md:text-sm md:mt-1 lg:mt-2 font-semibold text-[#1C274C]">Signup to your account</p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="w-3/4 md:w-1/2 lg:w-1/3 px-9 space-y-2 lg:space-y-3 mt-2">
                <p className="font-sans text-xs md:text-sm font-semibold text-[#1C274C]">Enter Your Name</p>
                <input type="text" name="fullName" value={formData.fullName} onChange={handleChange} className="w-full border border-[rgba(0,0,0,0.35)] rounded-md px-4 py-2 lg:py-2 focus:outline-none focus:border-black transition" />
              </div>

              <div className="w-3/4 md:w-1/2 lg:w-1/3 px-9 space-y-2 lg:space-y-3 mt-2">
                <p className="font-sans text-xs md:text-sm font-semibold text-[#1C274C]">Enter Your Email</p>
              ...
              <div className="flex justify-between px-9 items-center w-3/4 md:w-1/2 lg:w-1/3 text-[12px] md:text-sm text-[#1C274C] mt-2">
                <label className="flex items-center gap-1 md:gap-2 cursor-pointer">
                  <input type="checkbox" className="accent-[#6BDE23] md:size-4 size-3" />
                  <span className="font-semibold">Remember Me</span>
                </label>
                <a href="#" className="text-[#413B89] font-semibold hover:underline">Recover Password?</a>
              </div>

              <div className="px-9 mt-3 lg:mt-4 w-3/4 md:w-1/2 lg:w-1/3 flex justify-between items-center">
                <button onClick={handleSubmit} className="rounded-3xl py-2 lg:py-2 w-full text-sm md:text-base bg-[#6BDE23] text-white font-semibold">
                  SignUp
                </button>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center px-9 w-3/4 md:w-1/2 lg:w-1/3 mx-auto">
              <button className="bg-[#F3F9FA] w-full px-3 py-2 lg:py-2 rounded-md flex items-center justify-center gap-4">
                <Image src={google} alt="Google Logo" className="md:size-[25px] size-[20px]" />
                <span className="text-xs md:text-sm font-sans">Sign in With Google</span>
              </button>
            </div>
