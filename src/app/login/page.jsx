        ...
        <div className="flex justify-center items-center lg:h-[calc(100vh-64px)] my-auto">
          <div className="flex flex-col w-full">
            <div className="flex flex-col justify-center items-center">
              ...
              <h1 className="font-sans font-semibold text-xl md:text-2xl lg:text-4xl">Welcome Back!</h1>
              <p className="text-xs md:text-sm md:mt-1 lg:mt-2 font-semibold text-[#1C274C]">Login to your account</p>
            </div>
